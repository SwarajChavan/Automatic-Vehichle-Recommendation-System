 ...
 */
@WebServlet("/DealerUpdateVehicle")
public class DealerUpdateVehicle extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DealerUpdateVehicle() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendRedirect("dealer-vehicledetails?id="+id);
			rs.close();
			ps.close();
			conn.close();
