...
/**
 * Servlet implementation class DealerUpdateProfile
 */
@WebServlet("/DealerUpdateProfile")
public class DealerUpdateProfile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.println("window.location = 'dealer-updateprofile'");
			out.println("</script>");
	//		rs.close();
			ps.close();
			conn.close();
