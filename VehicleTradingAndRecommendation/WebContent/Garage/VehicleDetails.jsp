							...
							<div class="row">
								...
								<div class="col-md-7">
									<div class="desc">
										...
										<p><a href="ApproveVehicle?id=<%=rs.getString("id")%>&type=<%=rs.getString("type") %>&stat=Verified" class="btn btn-primary btn-addtocart">Safe Vehicle</a></p>
										<p><a href="ApproveVehicle?id=<%=rs.getString("id")%>&type=<%=rs.getString("type") %>&stat=Unsafe" class="btn btn-primary btn-addtocart">Unsafe Vehicle(Report to Admin)</a></p>
									</div>
								</div>
							</div>
						</div>
