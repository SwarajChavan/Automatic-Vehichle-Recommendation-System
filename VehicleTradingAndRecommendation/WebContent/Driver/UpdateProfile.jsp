...
PreparedStatement ps=conn.prepareStatement("select * from dealer where email=?");
							...
							<form action="DriverUpdateProfile" method="post">
								...
								<div class="row form-group">
									<div class="col-md-6 padding-bottom">
										...
										<input type="text" id="licno" name="licno" class="form-control" value="<%=rs.getString("license") %>" placeholder="Your License No." required="required">
									</div>
									<div class="col-md-6 padding-bottom">
										<label for="licexp">License Expiry Date</label>
										<input type="date" id="licexp" name="licexp" class="form-control" value="<%=rs.getString("licenceexp") %>" placeholder="Your License Expiry Date" required="required">
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-12">
								...
								<div class="row form-group">
									<div class="col-md-6 padding-bottom">
										...
										<input type="text" id="aadhar" name="aadhar" value="<%=rs.getString("aadhar") %>" pattern="[0-9]{12}" class="form-control" placeholder="Your Aadhar No.">
									</div>
									<div class="col-md-6 padding-bottom">
										<label for="experience">Experience (In Years)</label>
										<input type="number" id="experience" value="<%=rs.getString("experience") %>" name="experience" min="0" class="form-control" placeholder="Your Aadhar No.">
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-12 padding-bottom">
										<label for="address">Address.</label>
										<textarea type="text" id="address" name="address" class="form-control" placeholder="Your Aadhar No."><%=rs.getString("address") %></textarea>
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-12 padding-bottom">
