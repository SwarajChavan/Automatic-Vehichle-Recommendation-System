...
PreparedStatement ps1=conn.prepareStatement("select * from rentdataset where user=? limit 1");
ps1.setString(1, email);
ResultSet rs1=ps1.executeQuery();
if(rs1.next()){
	String filePath="G:\\BE_49_project\\AVTRS\\PythonCode\\RentRecommend.py";
	String[] cmd={
	...
	//function fo read the error or the output of the file
...
%>
	<input type="hidden" value="Car" id="vehicle">
		...
		<%}else{
			...
			%>
			<h2>Rent Vehicles to view Recommendations</h2>	
	<%	}
