...
PreparedStatement ps1=conn.prepareStatement("select * from buydataset where user=? limit 1");
ps1.setString(1, email);
ResultSet rs1=ps1.executeQuery();
if(rs1.next()){
	String filePath="G:\\BE_49_project\\AVTRS\\PythonCode\\CheckRecommend.py";
	String[] cmd={
...
%>
	<input type="hidden" value="Car" id="vehicle">
		...
		<h2>Checkout Vehicles to view Recommendations</h2>
		<%} %>
