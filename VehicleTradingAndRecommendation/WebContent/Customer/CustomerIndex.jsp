				   			...
				   			<div class="col-md-6 col-md-offset-3 col-md-pull-2 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner">
				   					<div class="desc">
					   					...
					   					<p><a href="customer-viewvehicle?type=Car&stat=Sell" class="btn btn-primary">Buy </a>
					   					<a href="customer-viewvehicle?type=Car&stat=Rent" class="btn btn-primary">Rent </a></p>
				   					</div>
				   				</div>
				   			</div>
				   		</div>
				   			...
				   			<div class="col-md-6 col-md-offset-3 col-md-pull-2 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner">
				   					<div class="desc">
					   					...
					   					<h2 class="head-3"></h2>
					   					<p class="category"><span>Buy and rent used cars</span></p>
					   					<p><a href="customer-viewbikes?type=Bike&stat=Sell" class="btn btn-primary">Buy</a>
					   					<a href="customer-viewbikes?type=Bike&stat=Rent" class="btn btn-primary">Rent</a></p>
				   					</div>
				   				</div>
				   			</div>
				   		</div>
					...
					<div class="col-md-3 text-center">
						<div class="product-entry">
							<div class="product-img" style="border-style: groove; border-radius: 25px;">
								...
								<p><strong><a href="customer-viewvehicle?type=Car&stat=Rent">RENT</a></strong></p>
								<p><strong><a href="customer-viewvehicle?type=Car&stat=Sell">BUY</a></strong></p>
								<div class="cart">
					...
					<div class="col-md-3 text-center">
						<div class="product-entry">
							<div class="product-img" style="border-style: groove; border-radius: 25px;">
								...
								<p><strong>VIEW MORE</strong></p>
								<p><strong><a href="customer-viewbikes?type=Bike&stat=Rent">RENT</a></strong></p>
								<p><strong><a href="customer-viewbikes?type=Bike&stat=Sell">BUY</a></strong></p>
								<div class="cart">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6 text-center">
						<div class="product-entry">
							<div class="product-img" style="border-style: groove; border-radius: 25px;">
								<p style="padding: 35px; font-size: xx-large; font-family: cursive;"><strong><a style="text-shadow: 2px 2px #191616;" href="rentrecommendation">Rent Recommendation</a></strong></p>
								<div class="cart">
					...
					<div class="col-md-6 text-center">
						<div class="product-entry">
							<div class="product-img" style="border-style: groove; border-radius: 25px;">
								<p style="padding: 35px; font-size: xx-large; font-family: cursive;"><strong><a style="text-shadow: 2px 2px #191616;" href="buyrecommendation">Buy Recommendation</a></strong></p>
								<div class="cart">
