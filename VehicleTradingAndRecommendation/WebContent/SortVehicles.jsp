...
<body>
	...
	condition="Where purpose='"+purpose+"' ";
	String vehicle = request.getParameter("vehicle");
	condition=condition +"AND type='"+vehicle+"' AND dealer='"+email+"' ";
...
<div class="col-md-4 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(GetImages?id=<%=rs.getString("id")%>);">
								<p class="tag"><span class="new"><%=rs.getString("purpose") %><span class="new">Verified</span></span></p>
								<div class="cart">
									<p>
