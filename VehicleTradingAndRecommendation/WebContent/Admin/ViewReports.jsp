			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
                      ...
                      PreparedStatement ps=conn.prepareStatement("SELECT * FROM `reportstolenvehicle` ORDER BY id DESC");
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
                      ...
                      <tbody>
                      <%
                      ps=conn.prepareStatement("SELECT * FROM `vehicle` where inspection='Unsafe'");
                      rs=ps.executeQuery();
                      i=0;
                      while(rs.next()){
                    	  i++;
                      ...
                      <td><%=rs.getString("dealer") %></td>
                      <td><a href="admin-vehicledetails?id=<%=rs.getString("id")%>">View</a></td>
                      </tr>
                      <%} 
                      rs.close();
      				ps.close();
