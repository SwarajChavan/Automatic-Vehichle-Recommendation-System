			...
			<div class="container">
				<div class="row">
					<div class="col-md-9 col-md-push-3">
						...
						<div id="output">
						<%
						PreparedStatement ps=conn.prepareStatement("select * from vehicle where purpose=? and type='Bike'");
						ps.setString(1, stat);
						...
						<div class="product-entry">
							<div class="product-img" style="background-image: url(GetImages?id=<%=rs.getString("id")%>);">
								...
								<div class="cart">
									<p>
										<span><a href="admin-vehicledetails?id=<%=rs.getString("id")%>"><i class="icon-eye"></i></a></span>
										<span><a href="admin-updatevehicle?id=<%=rs.getString("id")%>"><i class="fa fa-edit"></i></a></span>
									</p>
								</div>
							</div>
							<div class="desc">
								<h3><a href="admin-vehicledetails?id=<%=rs.getString("id")%>"><%=rs.getString("model") %></a></h3>
