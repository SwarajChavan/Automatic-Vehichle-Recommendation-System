...
%>
	...
	<input type="hidden" value="Bike" id="vehicle">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-9 col-md-push-3">
						...
						<div id="output">
						<%
						PreparedStatement ps=conn.prepareStatement("select * from vehicle where dealer=? and purpose=? and type='Bike'");
			                  ...
			                  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			                     <div class="panel panel-default">
			                         ...
			                         <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
			                             <div class="panel-body">
			                                 <ul>
			                                 	<li><input type="checkbox" name="type" id="Scooter" class="type" value="Scooter"><label for="Scooter">Scooter</label> </li>
			                                 	<li><input type="checkbox" name="type" id="Bike" class="type" value="Bike"><label for="SUV">Bike</label></li>
			                                 </ul>
			                             </div>
			                         </div>
			                     </div>
			                     <div class="panel panel-default">
			                         ...
			                         <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
			                             <div class="panel-body">
			                                <ul>
			                                 	<li><input type="checkbox" name="brand" id="Harley-Davidson" class="brand" value="Harley-Davidson"><label for="Harley-Davidson">Harley-Davidson</label> </li>
			                                 	<li><input type="checkbox" name="brand" id="BMW" class="brand" value="BMW"><label for="BMW">BMW</label></li>
			                                 	<li><input type="checkbox" name="brand" id="Kawasaki" class="brand" value="Kawasaki"><label for="Kawasaki">Kawasaki</label></li>
			                                 	<li><input type="checkbox" name="brand" id="Honda" class="brand" value="Honda"><label for="Honda">Honda</label> </li>
			                                 	<li><input type="checkbox" name="brand" id="Yamaha" class="brand" value="Yamaha"><label for="Yamaha">Yamaha</label></li>
			                                 	<li><input type="checkbox" name="brand" id="Suzuki" class="brand" value="Suzuki"><label for="Suzuki">Suzuki</label></li>
			                                 </ul>
			                             </div>
			                         </div>
			                     </div>
